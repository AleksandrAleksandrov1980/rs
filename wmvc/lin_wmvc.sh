...
dotnet publish /home/ustas/projects/git_main/rs/wmvc/wmvc.csproj -c Release -o /home/ustas/projects/git_main/rs/wmvc/wmvc -r linux-x64 --self-contained -p:PublishTrimmed=true
